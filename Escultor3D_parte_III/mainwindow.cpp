...
{
    ui->setupUi(this);
    ui->horizontalDimXCaixa->setMaximum(ui->widget->num_linhas);
    ui->horizontalDimYCaixa->setMaximum(ui->widget->num_colunas);
    ui->horizontalDimZCaixa->setMaximum(ui->widget->num_planos);
    ui->horizontalRaioXEllipsoid->setMaximum(ui->widget->num_linhas);
    ui->horizontalRaioYEllipsoid->setMaximum(ui->widget->num_colunas);
    ui->horizontalRaioZEllipsoid->setMaximum(ui->widget->num_planos);
    ui->horizontalRaioEsfera->setMaximum(ui->widget->num_linhas / 2);
    ui->horizontalZ->setMaximum(ui->widget->num_planos);
    ui->horizontalA->setValue(255);
    ...
    connect(ui->horizontalG,
            SIGNAL(valueChanged(int)),
            ui->widget,
            SLOT(mudaG(int)));

    connect(ui->horizontalB,
            SIGNAL(valueChanged(int)),
            ui->widget,
            SLOT(mudaB(int)));

    connect(ui->horizontalA,
            SIGNAL(valueChanged(int)),
            ui->widget,
            SLOT(mudaA(int)));
